...
def test_buffer_list():
    ...
    buffer_list = ensembling.BufferList([torch.tensor([1, 2, 3])])
    ...
    # Test the ensembling.BufferList class which contains a list of buffers.
    buffer_list = ensembling.BufferList([torch.tensor([1, 2, 3]), torch.tensor([4, 5, 6])])
    ...
    buffer_list = ensembling.BufferList([])
...
def test_buffer_list_in_module():
    ...
    class Model(torch.nn.Module):
        def __init__(self):
            super().__init__()
            self.buffer_list = ensembling.BufferList([torch.tensor([1, 2, 3])])
...
def test_empty_buffer_list_in_module():
    ...
    class Model(torch.nn.Module):
        def __init__(self):
            super().__init__()
            self.buffer_list = ensembling.BufferList()
